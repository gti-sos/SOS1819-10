...
app.get("/api/v1/e-car-statics/:country", (req, res) => {
...
app.get("/api/v1/e-car-statics/:country/:year", (req, res) => {
...
app.put("/api/v1/e-car-statics/:country/:year", (req, res) => {
...
app.delete("/api/v1/e-car-statics/:country/:year", (req, res) => {
